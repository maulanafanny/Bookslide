...
<section class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-6 col-lg-3 col-md-6 mt-4">
            <div class="card shadow card-dashboard" style="background-image: linear-gradient(to right top, #ff96a0, #f8808a, #f06973, #e7515c, #dc3545);">
        ...
        <div class="col-sm-6 col-lg-3 col-md-6 mt-4">
            <div class="card shadow card-dashboard" style="background-image: linear-gradient(to right top, #abb0b6, #9ba1a7, #8b9299, #7b838b, #6c757d);">
                <div class="card-body p-4">
                    <i class="bi bi-person dashboard-card-icons bg-secondary"></i>
                    <h2>Jumlah User</h2>
        ...
        <div class="col-sm-6 col-lg-3 col-md-6 mt-4">
            <div class="card shadow card-dashboard" style="background-image: linear-gradient(to right top, #b0d0ff, #8bb9ff, #67a1ff, #4288ff, #0d6efd);">
                <div class="card-body p-4">
